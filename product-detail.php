            ...
            <div class="aa-product-details-content">
              <div class="row">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">                              
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <?php
                              $sql = "SELECT * FROM products WHERE product_id=".$sid."";
                              ...
                              if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                  ...
                                  echo '<div class="simpleLens-big-image-container"><a data-lens-image="admin/images/'.$row['image'].'" class="simpleLens-lens-image"><img src="admin/images/'.$row['image'].'" class="simpleLens-big-image"></a></div>';
                                  echo '</div>';
                                  echo '</div>';
                                  echo '</div>';
                                  echo '</div>';
                  ...
                  echo   '<span class="aa-product-view-price">&#8377;'.$row['price'].'</span>';
                  ...
                  echo   '<a href="#">XL</a>';
                    ...
                    echo '</div>';
                   echo '<h4>Color</h4>';
                    echo '<div class="aa-color-tag">';
                    echo  '<a href="#" class="aa-color-green"></a>';
                    echo '<a href="#" class="aa-color-yellow"></a>';
                    echo  '<a href="#" class="aa-color-pink"></a>';                      
                    echo  '<a href="#" class="aa-color-black"></a>';
                    echo  '<a href="#" class="aa-color-white"></a>';                      
                    echo '</div>';
                    echo '<div class="aa-prod-quantity">';
                    echo'  <form action="">';
                    echo '<select id="" name="">';
                    echo  '<option selected="1" value="0">1</option>';
                   ...
                   echo '<div class="aa-prod-view-bottom">';
                    echo '  <a class="aa-add-to-cart-btn" href="cart.php?cartid='.$row['product_id'].'">Add To Cart</a>';
                     echo ' <a class="aa-add-to-cart-btn" href="#">Wishlist</a>';
                    echo '<a class="aa-add-to-cart-btn" href="#">Compare</a>';
                    echo '</div>';
                  echo '</div>';
                echo '</div>';
              echo '</div>';
